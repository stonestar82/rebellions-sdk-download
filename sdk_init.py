...
with open("download.sh", "w") as f:
    f.write(t.render(DEFAULT_PATH=DEFAULT_PATH, NFS_SDK_PATH=NFS_SDK_PATH, REBELLIONS_ID=REBELLIONS_ID, REBELLIONS_PW=REBELLIONS_PW, PYTHON_VERSIONS=PYTHON_VERSIONS))
